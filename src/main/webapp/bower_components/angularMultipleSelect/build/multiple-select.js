        ...
        function ($filter, $http) {
            return {
                ...
                link : function(scope, element, attr){
                    ...
                    scope.clickSelectedFn = function(item) {
                    	if(scope.clickSelected && typeof(scope.clickSelected) == 'function')
                    		scope.clickSelected(item);
                    }
                }
            };
        }

              ...
              var selectitem = $scope.selitem;
                  vm.isSaving = true;
                      ...
                      Upload.upload({
                          ...
                          params: {oppId: vm.oppMasterId,filetype:'Communication',uploadfileName:vm.uploadfileName,subject:vm.communicationLetter.subject}// {oppCode: inputData.oppCode, oppName: inputData.oppName, oppDescription: inputData.oppDescription, strategyMasterId: inputData.strategyMasterId.id}
                      }).then(function (resp) {

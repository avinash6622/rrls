(function () {
    ...
    angular
        ...
        .controller('DueDiligenceDialogController', DueDiligenceDialogController);

    DueDiligenceDialogController.$inject = ['OpportunityMaster', 'Principal', '$state', 'DueDiligences', '$scope', '$filter', '$http', '$sce', 'Upload'];

    function DueDiligenceDialogController(OpportunityMaster, Principal, $state, DueDiligences, $scope, $filter, $http, $sce, Upload) {
        var vm = this;

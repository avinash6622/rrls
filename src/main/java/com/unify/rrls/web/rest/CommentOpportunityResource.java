...
public class CommentOpportunityResource {
    ...
    public ResponseEntity<CommentOpportunity> createOpportunityComment(@RequestBody CommentOpportunity commentOpportunity)
        ...
        notificationServiceResource.notificationHistorysave(name,result.getCreatedBy(),result.getLastModifiedBy(),result.getCreatedDate(),"added",page,subContent,id,result.getOpportunityMaster().getId(),Long.parseLong("0"),result.getId());

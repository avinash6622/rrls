...
public class StrategyMasterResource {
    ...
    public ResponseEntity<StrategyMaster> createStrategyMaster(@Valid @RequestBody StrategyMaster strategyMaster) throws URISyntaxException {
        ...
        notificationServiceResource.notificationHistorysave(name,result.getCreatedBy(),result.getLastModifiedBy(),result.getCreatedDate(),"created",page,"",id,result.getId(),Long.parseLong("0"),Long.parseLong("0"));
    ...
    public ResponseEntity<StrategyMaster> updateStrategyMaster(@Valid @RequestBody StrategyMaster strategyMaster) throws URISyntaxException {
       ...
       StrategyMaster result = strategyMasterRepository.save(strategyMaster);
        ...
        notificationServiceResource.notificationHistorysave(name,result.getCreatedBy(),result.getLastModifiedBy(),result.getCreatedDate(),"updated",page,"",id,result.getId(),Long.parseLong("0"),Long.parseLong("0"));

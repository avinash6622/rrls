...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 28, 2017 at 12:31 PM
...
CREATE TABLE IF NOT EXISTS `jhi_user` (
  ...
  `research id` bigint(20) DEFAULT NULL,
  PRIMARY KEY (`id`),
  ...
  KEY `FK_UM-UMM_idx` (`research id`),
  KEY `FK_UM_UMM_idx` (`research id`)
...
INSERT INTO `jhi_user` (`id`, `login`, `password_hash`, `first_name`, `last_name`, `email`, `image_url`, `activated`, `lang_key`, `activation_key`, `reset_key`, `created_by`, `created_date`, `reset_date`, `last_modified_by`, `last_modified_date`, `role_id`, `research id`) VALUES
...
(22, 'girija', '$2a$10$UIDmDfk3tcyzoAjSGRahv.XV022Lu54QbienwwQR/FULqpYWv.FLC', NULL, NULL, 'girija0209@gmail.com', NULL, b'1', 'en', NULL, NULL, 'anonymousUser', '2017-12-06 12:06:44', NULL, 'girija', '2017-12-06 12:07:40', NULL, NULL),
(24, 'girija.p', '$2a$10$H2WJ276qGZBgKqTTUDzsVu4HRHfzKxsZabzFSx5UQ/1Iepc1tCisO', 'Girija', 'P', 'girija.p@noahdatatech.com', NULL, b'1', 'en', NULL, '22002301775708591460', 'admin', '2017-12-14 12:15:05', '2017-12-14 10:35:53', 'admin', '2017-12-14 10:36:01', 1, NULL);
...
CREATE TABLE IF NOT EXISTS `opportunity_master` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_opportunity_master_opportunity_master_id` (`strategy_master_id`),
...
INSERT INTO `opportunity_master` (`id`, `opp_description`, `strategy_master_id`, `created_by`, `last_modified_by`, `created_date`, `last_modified_date`, `master_name`) VALUES
(7, 'Financial institution', 2, 'user', 'admin', NULL, '2017-12-21 06:49:27', 7),
(9, 'Software company', 3, 'admin', 'user', '2017-12-04 09:46:07', '2017-12-04 09:46:07', 15),
(12, 'The oil and gas industry', 2, 'admin', 'admin', NULL, '2017-12-06 06:12:50', 1),
(13, 'Software company', 2, 'admin', 'admin', '2017-11-28 06:20:52', '2017-11-28 06:20:52', 11),
(20, 'The oil and gas industry', 2, 'admin', 'admin', NULL, '2017-12-06 06:13:09', 1),
(24, 'Trading distri', 6, 'admin', 'admin', NULL, '2017-12-14 06:13:30', 12),
(26, 'test', NULL, 'admin', 'admin', NULL, '2017-12-21 06:43:22', 5);
...
INSERT INTO `ra_file_upload` (`id`, `file_name`, `file_data`, `file_data_content_type`, `add_file_flag`, `opportunity_master_id`, `created_by`, `last_modified_by`, `created_date`, `last_modified_date`) VALUES
(1, 'Unifi1.docx', 'src\\main\\resources\\fileUpload\\Unifi1.docx', NULL, NULL, 20, 'admin', 'admin', '2017-11-21 12:30:41', '2017-11-21 12:30:41'),
(2, 'Unifi1.docx', 'src\\main\\resources\\fileUpload\\Unifi1.docx', NULL, NULL, NULL, 'admin', 'admin', '2017-11-27 11:43:29', '2017-11-27 11:43:29'),
(6, 'Unifi Sample.docx', 'src\\main\\resources\\fileUpload\\Unifi Sample.docx', NULL, NULL, 7, 'admin', 'admin', '2017-11-27 12:29:12', '2017-11-27 12:29:12'),
(7, 'DFA samples.docx', 'src\\main\\resources\\fileUpload\\DFA samples.docx', NULL, NULL, 7, NULL, NULL, '2017-12-19 09:56:14', NULL);
...
ALTER TABLE `jhi_user`
  ...
  ADD CONSTRAINT `FK_UM_UMM` FOREIGN KEY (`research id`) REFERENCES `jhi_user` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
...
ALTER TABLE `opportunity_master`
  ...
  ADD CONSTRAINT `FK_OM_SM` FOREIGN KEY (`strategy_master_id`) REFERENCES `strategy_master` (`id`) ON DELETE NO ACTION ON UPDATE NO ACTION;
